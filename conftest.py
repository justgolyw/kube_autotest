...
# @pytest.fixture(scope="session")
# def create_cluster_session(admin_mc, get_cloud_pods_session, remove_resource_session, tmp_path_factory, worker_id):
#     """
#     session级别的cluster
#     """
#
...
#         client = admin_mc.client
#         # 获取节点
#         pod = get_cloud_pods_session(1)[0]
...
#
#         # 添加节点
#         kwargs = get_node_kwargs(cluster.id, public_ip, etcd=True, control=True, worker=True)
#         node = nodes.create_node(client, **kwargs)
#         # 等待节点状态为active
...
#             fn.write_text(json.dumps(cluster_id))
#
#         return cluster